  ...
  return (
    <footer className="mt-auto w-full bg-gradient-to-b from-slate-900 via-slate-900 to-black text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-80 h-80 sm:w-96 sm:h-96 bg-red-500/10 rounded-full blur-3xl"></div>
        <div className="absolute -bottom-40 -left-40 w-80 h-80 sm:w-96 sm:h-96 bg-amber-500/10 rounded-full blur-3xl"></div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1 space-y-6">
            <Link to="/" className="inline-flex items-center gap-3 group">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-red-500 to-red-600 flex items-center justify-center shadow-lg shadow-red-500/25 group-hover:shadow-red-500/40 transition-all duration-300 group-hover:scale-105">
                <span className="text-white font-black text-xl">D</span>
              </div>
              <div>
                <h2 className="text-2xl font-bold text-white group-hover:text-red-400 transition-colors">Derana</h2>
          ...
          <div className="space-y-6">
            <h3 className="text-lg font-bold text-white relative inline-flex items-center gap-2">
              Quick Links
              <span className="w-12 h-1 bg-gradient-to-r from-red-500 to-red-600 rounded-full"></span>
            </h3>
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.to}>
                  ...
                  >
                    <FaAngleRight className="text-red-500 group-hover:translate-x-1 transition-transform duration-300" size={12} />
          ...
          <div className="space-y-6">
            <h3 className="text-lg font-bold text-white relative inline-flex items-center gap-2">
              Categories
              <span className="w-12 h-1 bg-gradient-to-r from-amber-500 to-orange-500 rounded-full"></span>
            </h3>
            <ul className="space-y-3">
              {categories.map((link) => (
                <li key={link.to}>
                  <Link
                    ...
                    className="text-slate-400 hover:text-white text-sm flex items-center gap-2 group transition-all duration-300"
                  >
                    <FaAngleRight className="text-amber-500 group-hover:translate-x-1 transition-transform duration-300" size={12} />
                    <span className="group-hover:translate-x-1 transition-transform duration-300">{link.label}</span>
                  </Link>
                </li>
              ))}
            ...
            <ul className="space-y-4">
              <li>
                <a href="tel:077-5976783" className="text-slate-400 hover:text-white text-sm flex items-start gap-3 group transition-all duration-300">
                  <span className="w-10 h-10 rounded-xl bg-red-500/10 flex items-center justify-center shrink-0 group-hover:bg-red-500/20 group-hover:scale-110 transition-all">
                    <FaPhone className="text-red-400" size={14} />
                  </span>
                  <div>
              ...
              <li>
                <a href="mailto:malshanherath88@gmail.com" className="text-slate-400 hover:text-white text-sm flex items-start gap-3 group transition-all duration-300">
                  <span className="w-10 h-10 rounded-xl bg-amber-500/10 flex items-center justify-center shrink-0 group-hover:bg-amber-500/20 group-hover:scale-110 transition-all">
                    <FaEnvelope className="text-amber-400" size={14} />
                  </span>
              ...
              <li className="text-slate-400 text-sm flex items-start gap-3">
                <span className="w-10 h-10 rounded-xl bg-slate-500/10 flex items-center justify-center shrink-0">
            ...
            <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row w-full lg:w-auto gap-3">
              <div className="relative flex-1 sm:min-w-[280px]">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3.5 rounded-xl bg-white/5 border border-white/10 text-white placeholder-slate-500 text-sm focus:outline-none focus:border-red-500 focus:ring-2 focus:ring-red-500/20 transition-all"
                  required
                />
              </div>
              <button
                type="submit"
                className="px-8 py-3.5 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white text-sm font-bold rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-red-500/25 hover:scale-105 flex items-center justify-center gap-2"
              >
                {isSubscribed ? (
                  <>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-slate-500 text-sm text-center sm:text-left">
              ...
              <span className="text-red-400 font-semibold">Derana</span>. Developed with{" "}
              <FaHeart className="inline text-red-500 mx-1" size={12} />
              by <span className="text-amber-400 font-semibold">Malshan</span>
            </p>
      ...
      <button
        onClick={scrollToTop}
        className="fixed bottom-6 right-6 w-12 h-12 rounded-xl bg-gradient-to-r from-red-500 to-red-600 text-white flex items-center justify-center shadow-lg shadow-red-500/30 hover:shadow-red-500/50 hover:scale-110 transition-all duration-300 group z-40"

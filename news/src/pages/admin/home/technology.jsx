    ...
    if (state === "loading") {
      axios
        ...
        .then((res) => {
          ...
          setTechNews(filtered);
          setState("success");
        })
        .catch((error) => {
          console.error(error);
          toast.error("Error fetching technology news!");
          setState("error");
        });
    }
  }, [state]);
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-10">
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <p className="mt-2 text-sm sm:text-base text-gray-600">
            Discover the latest in tech and innovation
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
          {state === "loading" && (
            <div className="col-span-full flex items-center justify-center py-12">
              <div className="text-center">
                ...
                <p className="mt-4 text-gray-600">Loading technology news...</p>
              </div>
            </div>
          )}
          ...
          {state === "error" && (
            <div className="col-span-full">
              <div className="text-red-700 bg-red-50 border border-red-200 rounded-lg px-4 py-6 sm:px-6 text-center">
                <p className="font-semibold">Failed to load technology news</p>
                <button 
          ...
          {state === "success" && techNews.length === 0 && (
            <p className="col-span-full text-center text-gray-600 bg-gray-50/80 backdrop-blur border border-gray-200 rounded-lg px-4 py-8">
              No technology news available at the moment.
            </p>
          )}

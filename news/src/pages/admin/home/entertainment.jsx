  ...
  useEffect(() => {
    if (state === "loading") {
      axios
        ...
        .catch((error) => {
          console.error(error);
          toast.error("Error fetching entertainment news!");
          setState("error");
        });
    }
  }, [state]);
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-10">
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <p className="mt-2 text-sm sm:text-base text-gray-600">
            Stay updated with the latest entertainment stories
          </p>
        </div>
          ...
          {state === "loading" && (
            <div className="col-span-full flex items-center justify-center py-12">
              <div className="text-center">
                ...
                <p className="mt-4 text-gray-600">Loading entertainment news...</p>
              </div>
            </div>
          )}
          ...
          {state === "error" && (
            <div className="col-span-full">
              <div className="text-red-700 bg-red-50 border border-red-200 rounded-lg px-4 py-6 sm:px-6 text-center">
                <p className="font-semibold">Failed to load entertainment news</p>
                <button 
